...
<section class="row formAdicionadrDados">
    ...
    <section class="col-md-4">
    	<div class="input-group">
            ...
            <input type="text" class="form-control" id="periodo_produto" placeholder="Período da Viagem" aria-describedby="basic-addon1" value="<?php echo $Item['periodo_produto']; ?>"></div>
        </div>
    </section>
</section>
...
<section class="row formAdicionadrDados">
    <section class="col-md-8">
    	<div class="input-group">
  			...
  			<textarea type="text" class="form-control" id="transporte_produto" placeholder="Informações sobre o transporte..." aria-describedby="basic-addon1" rows="3"><?php echo $Item['transporte_produto']; ?></textarea>
		</div>
    </section>
</section>
...
<section class="row formAdicionadrDados">
    <section class="col-md-8">
    	<div class="input-group">
  			...
  			<textarea type="text" class="form-control" id="hospedagem_produto" placeholder="Informações sobre a hospedagem..." aria-describedby="basic-addon1" rows="3"><?php echo $Item['hospedagem_produto']; ?></textarea>
		</div>
    </section>
</section>
...
<section class="row formAdicionadrDados">
    <section class="col-md-8">
        <div class="input-group">
            ...
            <textarea type="text" class="form-control" id="estrutura_produto" placeholder="Informações do Produto..." aria-describedby="basic-addon1" rows="5"><?php echo $Item['estrutura_produto']; ?></textarea>
        </div>
    </section>
</section>
...
<section class="row formAdicionadrDados">
    <section class="col-md-8">
        <div class="input-group">
            ...
            <textarea type="text" class="form-control" id="info_produto" placeholder="Informações complementares..." aria-describedby="basic-addon1" rows="3"><?php echo $Item['info_produto']; ?></textarea>
        </div>
    </section>
</section>
<br/>
