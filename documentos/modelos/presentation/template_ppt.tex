...
%
% Esse templete teve como base:
% https://pt.sharelatex.com/templates/presentations/air-beamer-template
%
% Desenvolvido pela Equipe Joan Clarke de Pesquisas
...
\pdfinfo
{
  /Title       (Template de Apresentação NextStep 2016)
  /Creator     (Equipe Joan Clarke)
